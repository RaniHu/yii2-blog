...
/**
 * Theme represents an application themes.
 *
 * When [[View]] renders a view file, it will check the [[View::themes|active themes]]
 * to see if there is a themed version of the view file exists. If so, the themed version will be rendered instead.
 *
 * A themes is a directory consisting of view files which are meant to replace their non-themed counterparts.
 *
 ...
 *
 * To use a themes, you should configure the [[View::themes|themes]] property of the "view" application
 ...
 * ```
 *
 * The above configuration specifies a themes located under the "themes/basic" directory of the Web folder
 * that contains the entry script of the application. If your themes is designed to handle modules,
 ...
 *
 * @property string $basePath The root path of this themes. All resources of this themes are located under this
 * directory.
 * @property string $baseUrl The base URL (without ending slash) for this themes. All resources of this themes
...
class Theme extends Component
{
     ...
     * This property is used by [[applyTo()]] when a view is trying to apply the themes.
    ...
    /**
     * @return string the base URL (without ending slash) for this themes. All resources of this themes are considered
    ...
    /**
     * @param string $url the base URL or [path alias](guide:concept-aliases) for this themes. All resources of this themes are considered
     * to be under this base URL.
     */
    ...
    /**
     * @return string the root path of this themes. All resources of this themes are located under this directory.
     * @see pathMap
     */
    ...
    /**
     * @param string $path the root path or [path alias](guide:concept-aliases) of this themes. All resources of this themes are located
