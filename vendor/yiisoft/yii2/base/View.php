...
class View extends Component
{
    ...
    /**
     * @var Theme|array|string the themes object or the configuration for creating the themes object.
     ...
     * Renders a view file.
     *
     * If [[themes]] is enabled (not null), it will try to render the themed version of the view file as long
     * as it is available.
     *
