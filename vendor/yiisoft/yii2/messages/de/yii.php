...
return [
    ...
    'in {delta, plural, =1{a day} other{# days}}' => 'in {delta, plural, =1{einem ArticleTag} other{# Tagen}}',
    ...
    '{delta, plural, =1{1 day} other{# days}}' => '{delta, plural, =1{1 ArticleTag} other{# Tage}}',
    ...
    '{delta, plural, =1{a day} other{# days}} ago' => 'vor {delta, plural, =1{einem ArticleTag} other{# Tagen}}',
